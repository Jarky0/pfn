...
class UIEffects {
    ...
    flipCard() {
        ...
        if (this.compoundWordDisplay) this.compoundWordDisplay.style.backgroundColor = "#f0f0f0";
    ...
    unflipCard() {
        ...
        if (this.compoundWordDisplay) this.compoundWordDisplay.style.backgroundColor = "#fff";
    ...
    updateTimerRing(percentage) {
        ...
        const startColorR = 52, startColorG = 152, startColorB = 219;
        const endColorR = 231, endColorG = 76, endColorB = 60;
